...
void build(char *compiler, char *cpp_compiler, char *cpp_linker, char *os, char *arch) {
    char *c_shared = "-DLIBUS_USE_LIBUV -fsanitize=address -g -c -fPIC -I uWebSockets/uSockets/src uWebSockets/uSockets/src/*.c uWebSockets/uSockets/src/eventing/*.c";
    char *cpp_shared = "-DLIBUS_USE_LIBUV -fsanitize=address -g -c -fPIC -std=c++17 -I uWebSockets/uSockets/src -I uWebSockets/src src/addon.cpp";
